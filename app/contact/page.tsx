...
const steps = [
  {
    ...
    desc: "We read every inquiry personally — no auto-responses, no gatekeeping VA.",
  },
  {
    num: "02",
    title: "You hear back within 24 hrs",
    desc: "We'll respond with honest feedback on fit, timeline, and rough budget range.",
  },
  {
    num: "03",
    title: "We scope the project together",
    desc: "A short call to align on goals, constraints, and what success looks like.",
  },
  {
    num: "04",
    title: "We get to work",
    desc: "Proposal signed, kickoff scheduled. You get a dedicated team from day one.",
  },
];
...
const channels = [
  {
    label: "Email",
    value: "hello@viklance.dev",
    href: "mailto:hello@viklance.dev",
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path d="M2 4.5l6 4.5 6-4.5M2 4.5h12v8H2v-8z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    label: "Twitter / X",
    value: "@viklance",
    href: "https://twitter.com/viklance",
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path d="M2 2.5h3.5L14 13.5h-3.5L2 2.5z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round" strokeLinecap="round" />
        <path d="M2 13.5l4.5-4.5M14 2.5l-4.5 4.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    label: "LinkedIn",
    value: "Viklance",
    href: "https://linkedin.com/company/viklance",
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <rect x="2" y="2" width="12" height="12" rx="2" stroke="currentColor" strokeWidth="1.3" />
        <path d="M5 7v4M5 5.5v.01M8 11V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5V11" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
      </svg>
    ),
  },
];
        ...
        <section className="relative bg-neutral-100 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 pt-40 pb-24">
            ...
            <p className="text-base sm:text-lg text-neutral-700 max-w-xl leading-relaxed">
              ...
              and we&apos;re always honest about fit.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-start">
              ...
              <div className="flex flex-col gap-12">
                {/* channels */}
                <div>
                  <p className="text-[11px] font-semibold tracking-widest uppercase text-neutral-600 mb-6">
                    Reach us directly
                  </p>
                  <div className="flex flex-col gap-4">
                    {channels.map((c) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="text-[11px] font-semibold tracking-widest uppercase text-neutral-500">
                            {c.label}
                          </p>
                  ...
                  <div className="flex flex-col gap-6">
                    {steps.map((s) => (
                      <div key={s.num} className="flex gap-4">
                        <span className="text-[11px] font-bold tracking-widest text-neutral-300 pt-0.5 shrink-0">
                          {s.num}
                        </span>
                        <div>
                ...
                {sent ? (
                  <div className="flex flex-col items-center justify-center gap-5 py-24 text-center">
                    ...
                    <button
                      ...
                      className="mt-2 text-sm font-semibold text-neutral-500 hover:text-neutral-900 underline underline-offset-2 transition-colors"
                    >
                  ...
                  <form onSubmit={submit} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <textarea
                        required
                        rows={5}
                        placeholder="Tell us about your project, timeline, and what you need built..."
